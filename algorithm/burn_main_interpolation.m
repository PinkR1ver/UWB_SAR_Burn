...
interpolation_dis = 0.0005;

tic
new_s = aperture_interpolation(s, X_aper, Y_aper, interpolation_dis, Xbeg, Xend, Ybeg, Yend);
s = new_s;
toc
...
index_row_max = (Xend - Xbeg) / interpolation_dis + 1;
index_col_max = (Yend - Ybeg) / interpolation_dis + 1;
...
dx = interpolation_dis; % pixel distance calulated from the data
dy = interpolation_dis;
